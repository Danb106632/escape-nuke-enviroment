...
# (C) 2025 - Xavier Bourque - www.pixelfudger.com
#############################################################
...
# Remove the '#' on the next line to disable 'Group View' by default on all groups in Nuke 16+ 
#nuke.knobDefault("Group.disable_group_view", "1")

aboutMsg = 'Pixelfudger 3.4\nJune 2025\nCreated by: Xavier Bourque\nwww.pixelfudger.com\n(c) 2011-2025'

t=nuke.menu("Nodes")
u=t.addMenu("Escape Studios/Pixelfudger3", icon="PxF_Menu3.png")
